...
public class RoomBox extends CorpusRole {
	...
	public RoomBox(RoleHooks roleHooks, ObjectProperties properties) {
		...
		if(roomMusicStr != null) {
			...
			myAgentHooks.addPropertyListener(false, CommonKV.Room.KEY_MUSIC,
		...
		if(scrollDir != null) {
			myAgentHooks.addPropertyListener(false, CommonKV.Room.KEY_SCROLL_DIR,
		...
		if(isPushBox != null) {
			myAgentHooks.addPropertyListener(false, CommonKV.Room.KEY_SCROLL_PUSHBOX,
		...
		if(isKillBox != null) {
			myAgentHooks.addPropertyListener(false, CommonKV.Room.KEY_SCROLL_KILLBOX,
					new AgentPropertyListener<Boolean>(Boolean.class) {
					@Override
		...
		myAgentHooks.addPropertyListener(false, CommonKV.Room.KEY_SPACEWRAP_X,
				new AgentPropertyListener<Boolean>(Boolean.class) {
				@Override
