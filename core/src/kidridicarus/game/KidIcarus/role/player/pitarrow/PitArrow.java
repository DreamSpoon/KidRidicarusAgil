...
public class PitArrow extends Role {
	...
	public PitArrow(RoleHooks roleHooks, ObjectProperties properties) {
		...
		PitArrowBody body = new PitArrowBody(myPhysHooks, RP_Tool.getCenter(properties),
		...
		sprite = new PitArrowSprite(myGfxHooks.getAtlas(),
